										...
										<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse m-none">
											<nav class="wrapper-spy">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														<a href="#cases" data-hash data-hash-offset="32">
															Thành tựu
														</a>
													</li>
													<li>
				...
				<section id="who-we-are" class="section section-no-border background-color-light m-none">
					<div class="container">
						<div class="row center">
							<div class="col-md-12">
								<h2>Chúng tôi là..</h2>
								<p class="custom-section-sub-title">ABOUT JDHUB COMPANY</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<p>
									<strong class="font-weight-semibold text-color-dark">JDHUB là công ty ba trong một với Đào Tạo, Nhân Lực và Dịch Vụ. </strong><br>
									Chúng tôi với nhiệt huyết của những người con Việt Nam từng đi làm và học Tập một thời gian dài về các lĩnh vực bên họ và đặt biệt là về mảng công nghệ thông tin. Với mong muốn thổi một luồn gió mới vào  Đà Nẵng nói riêng hay Việt Nam nói chung về phát triển nguồn lực IT ở Việt Nam và chúng tôi mong muốn sẽ là cầu nối ngắn nhất để thực hiên giấc mơ Việt-Nhật tại cộng đồng ta.
								</p>
							</div>
							...
							<div class="col-md-6 match-height">
								<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
	 								...
	 								<div class="feature-box-info">
	  									...
	  									<p class="tall">Thông qua mạng lưới đối tác rộng lớn, cộng với bề dày kinh nghiệm trên nhiều lĩnh vực tại Nhật Bản, JDHUB đã và đang thành công trong sứ mệnh kết nối tinh hoa Giáo dục Nhật Bản tới Việt Nam. Từ đó JDHUB được nhiều đối tác lớn tại Nhật chọn mặt gửi vàng để chuyển giao mô hình cũng như các giá trị giáo dục Nhật Bản đến Việt Nam.</p>
	  								</div>
	 							</div>
	 							<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
	 								<div class="feature-box-icon">
	 								...
	 								<div class="feature-box-info">
	  									<h4 class="mb-none">THIẾT KẾ VÀ PHÁT TRIỂN WEB</h4>
	  									<p class="tall">JDHUB không sáng tạo những điều xa vời mà cam kết cùng bạn đạt được mục tiêu đặt ra trong thời gian ngắn nhất.
Chúng tôi mang đến giải pháp thiết kế web, thiết kế phần mềm & nhận diện thương hiệu NHANH GỌN - CHUYÊN NGHIỆP - GIÁ PHÙ HỢP cho doanh nghiệp, cửa hàng trực tuyến của bạn.</p>
	  								</div>
	 							</div>
	 							<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
	 								<div class="feature-box-icon">
	 								...
	 								<div class="feature-box-info">
	  									<h4 class="mb-none">DỊCH VỤ</h4>
	  									<p class="tall">Chúng tôi không những chỉ muốn đem đến những giá trị Nhật Bản để với bạn qua những bài vở và trang sách các bạn học được Chúng tôi tạo một môi trường "Chuẩn Nhật" tại Việt Nam. Đội ngũ giảng viên hay từng người trong công ty đề sẽ là một chuẩn để các bạn học hỏi và tìm hiểu về chính cách người Nhật sinh hoạt và làm việc ngay tại quê hương đất nước chúng ta. Đào tạo nguồn nhân lực chất lượng để cộng tác làm việc vói các doanh nghiệp của Nhật.</p>
	  								</div>
	 							</div>
									...
									<div>
										<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
											<div class="testimonial testimonial-with-quotes testimonial-style-2 custom-testimonial-style-1 center mb-none">
												<blockquote>
													<p>JDHUB được viết tắt từ Japan and Đà Nẵng Hub có nghĩa là sự liên kết giữa Nhật Bản và Đà Nẵng  Đặt tên tổ chức là JDHUB, chúng tôi mong muốn mỗi cá nhân trong tập thể mà chúng tôi xây dựng luôn cùng nhau học tập, cùng nhau phát triển, cùng nhau xây dựng tổ chức lớn mạnh. Sự gắn kết này chính là tinh thần của người JDHUB, đồng thời cũng là nguồn cội của sức mạnh tạo ra những sản phẩm và dịch vụ có giá trị to lớn để phụng sự khách hàng, cũng như đóng góp công sức vào tiến trình xây dựng một Việt Nam tươi sáng hơn. </p>
												</blockquote>
				...
				<section id="portfolio" class="section section-no-border background-color-light m-none pb-xlg">
					<div class="container">
						<div class="row center">
							<div class="col-md-12">
								<h2>Các hoạt động của công ty</h2>
					...
					<div class="container-fluid">
						<div class="row">
							<ul class="nav nav-pills sort-source custom-nav-filter custom-center-pills" data-sort-id="portfolio" data-option-key="filter">
								<li data-option-value="*" class="active"><a href="#">Tổng quan</a></li>
								<li data-option-value=".website"><a href="#">Công Nghệ</a></li>
								<li data-option-value=".brands"><a href="#">Giáo dục</a></li>
								<li data-option-value=".mobile-app"><a href="#">Dịch vụ</a></li>
								<li data-option-value=".others"><a href="#">Khác..</a></li>
							</ul>
								...
								<div class="owl-carousel show-nav-title custom-arrows-style-1" data-plugin-options="{'responsive': {'767': {'items': 1}, '1200': {'items': 3}}, 'margin': 15, 'loop': false, 'dots': false, 'nav': true}">
										...
										<article class="thumb-info custom-thumb-info-style-2">
											<span class="thumb-info-wrapper m-none">
												<a href="#" class="text-decoration-none" title="Porto Website">
													<img src="img/demos/one-page-agency/cases/case-1.jpg" class="img-responsive" alt="">
												</a>
											</span>
											<span class="thumb-info-caption background-color-light center p-md">
												...
												<p class="custom-thumb-info-category">COSMOS</p>
											</span>
										</article>
									...
									<div class="center">
										<article class="thumb-info custom-thumb-info-style-2">
											<span class="thumb-info-wrapper m-none">
												<a href="#" class="text-decoration-none" title="Porto Website">
													<img src="img/demos/one-page-agency/cases/case-2.jpg" class="img-responsive" alt="">
												</a>
											</span>
											<span class="thumb-info-caption background-color-light center p-md">
												<h4>
												...
												<p class="custom-thumb-info-category">BrSE</p>
											</span>
										</article>
										<a href="#" class="btn custom-btn-style-1 text-color-dark mt-md">VIEW MORE</a>
									</div>
									<div class="center">
										<article class="thumb-info custom-thumb-info-style-2">
											<span class="thumb-info-wrapper m-none">
												<a href="#" class="text-decoration-none" title="Porto Website">
													<img src="img/demos/one-page-agency/cases/case-3.jpg" class="img-responsive" alt="">
												</a>
											</span>
											<span class="thumb-info-caption background-color-light center p-md">
												<h4>
												...
												<p class="custom-thumb-info-category">TESTCASE</p>
											</span>
										</article>
										<a href="#" class="btn custom-btn-style-1 text-color-dark mt-md">VIEW MORE</a>
									</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-5">
								...
								<a href="#" class="btn custom-btn-style-1 _color-2 text-color-light mt-xlg">Đăng Kí Tại Đây</a>
							</div>
						</div>
					</div>
				</section>
							...
							<div class="col-md-12">
								<div class="owl-carousel custom-arrows-style-1 custom-nav-pos-1 mb-none" data-plugin-options="{'items': 4, 'margin': 90, 'loop': false, 'dots': false, 'nav': true, 'stagePadding': 40}">
									...
									<div>
										<span class="thumb-info custom-thumb-info-style-2">
											<span class="thumb-info-wrapper _rounded m-none">
												<a href="#team-content-3" class="popup-with-zoom-anim text-decoration-none" title="Đoàn Thị Hương Ly">
											...
											<span class="thumb-info-caption background-color-light center p-md">
												...
												<p class="custom-thumb-info-category">Thư Kí</p>
											</span>
										</span>
										<div id="team-content-3" class="dialog dialog-lg zoom-anim-dialog mfp-hide p-xlg">
											<div class="row">
												...
												<div class="col-md-8 col-sm-8">
													<h2 class="font-weight-semibold text-color-dark">Đoàn Thị Hương Ly</h2>
													<p>Thư Kí</p>
													<p class="font-size-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc at elementum lacus. Fusce luctus urna ac mauris consequat, ac eleifend odio imperdiet. Sed euismod tempor orci, ullamcorper accumsan justo semper eu. Donec venenatis elit et euismod iaculis. Integer vehicula imperdiet metus at convallis. Donec ullamcorper at nunc lobortis ultricies. Nam tincidunt.</p>	
													<p class="font-size-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In imperdiet faucibus congue. Donec at volutpat nisl. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Maecenas risus dui.</p>
												</div>
				...
				<div class="google-map m-none custom-contact-pos">
                    <img src="img/ggmap.png" alt class="img-responsive"/>
                </div>
