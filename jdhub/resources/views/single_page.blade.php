...
<head>
    ...
    <link href="../images/logotitle.png" rel="icon">
			...
			<div class="widget widget_links clearfix">
				...
				<div style="font-size: 14px; line-height: 1.7;">
					<address style="line-height: 1.7;">
						Đà Nẵng,Liên Chiểu<br>
						Ninh Tốn 82<br>
					</address>

					<div class="clear topmargin-sm"></div>

					<abbr title="Phone Number">Phone:</abbr> (0236) 789 10<br>
					<abbr title="Fax">Fax:</abbr> (089) 1234 567<br>
					<abbr title="Email Address">Email:</abbr> info@jdhub.com
				</div>
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="full-header transparent-header border-full-header dark static-sticky" data-sticky-class="not-dark" data-sticky-offset="full" data-sticky-offset-negative="100">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="images/LogoJDH.png"><img src="images/logoJH2.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="images/logoJH1_dark.png"><img src="images/logoJH_dark.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						<ul class="one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
							...
							<li><a href="#" data-href="#section-about"><div>Thông tin chung</div></a></li>
							<li><a href="#" data-href="#section-works"><div>Phương châm hoạt động</div></a></li>
		...
		<section id="slider" class="slider-parallax full-screen force-full-screen">
			...
			<div class="slider-parallax-inner">
				...
				<div class="full-screen force-full-screen dark section nopadding nomargin noborder ohidden" style="background-image: url('images/page/background.png'); background-size: cover; background-position: center center;">

					<div class="container center">
						<div class="vertical-middle">
							<div class="emphasis-title">
								<h1>
									<span class="text-rotater" data-separator="|" data-rotate="fadeIn" data-speed="6000" >
										<span class="t-rotate t700 font-body opm-large-word">Giáo dục|Thiết kế Web|Dịch vụ|Đào tạo IT|Nhân Lực</span>
									</span>
								</h1>
							</div>
							<a href="#" class="button button-border button-light button-circle" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Tìm hiểu thêm...</a>
						</div>
					</div>
			...
			<div class="content-wrap nopadding">
				...
				<div id="section-about" class="center page-section">
					...
					<div class="container clearfix">
						...
						<h2 class="divcenter bottommargin font-body" style="max-width: 700px; font-size: 40px;">JDHUB nỗ lực xây dựng tổ hợp dịch vụ toàn diện, chất lượng Nhật Bản về Giáo dục, Nhân sự &amp;chú trọng về chất lượng cũng như đầu ra cho học viên  </h2>

						<p class="lead divcenter bottommargin" style="max-width: 800px;">Thông qua mạng lưới đối tác rộng lớn, cộng với bề dày kinh nghiệm trên nhiều lĩnh vực tại Nhật Bản, KYODAI đã và đang thành công trong sứ mệnh kết nối tinh hoa Giáo dục Nhật Bản tới Việt Nam. Từ đó KYODAI được nhiều đối tác lớn tại Nhật chọn mặt gửi vàng để chuyển giao mô hình cũng như các giá trị giáo dục Nhật Bản từ Mầm non đến Đại học tại Việt Nam.</p>
						...
						<div class="row topmargin-lg divcenter" style="max-width: 1000px;">
							...
							<div class="col-sm-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="images/team/1.jpg" alt="Dao Trong Hieu">
									...
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Đào Trọng Hiếu</h4><span>CEO</span></div>
									</div>
								</div>
							...
							<div class="col-sm-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="images/team/2.jpg" alt="Nguyen Thanh Tu">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
													<i class="icon-twitter"></i>
									...
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Nguyễn Thanh Tú</h4><span>Co-Founder</span></div>
									</div>
								</div>
							...
							<div class="col-sm-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="images/team/3.jpg" alt="Doan Thi Huong Ly">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
													<i class="icon-twitter"></i>
									...
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Đoàn Thị Hương Ly</h4><span>Sales</span></div>
									</div>
								</div>
					...
					<div class="section nomargin">
						<div class="container clearfix">
							<div class="divcenter center" style="max-width: 900px;">
								<h2 class="nobottommargin t300 ls1">JDHUB liên kết với trung tâm Nhật Ngữ Cosmos với các hạng mục Đào Tạo Tiếng Nhật Sơ,Trung và Cao cấp ,Tiếng Nhật business ,Tiếng Nhật IT</h2>
							</div>
						</div>
					</div>
				...
				<div id="section-services" class="page-section notoppadding">
					...
					<div class="section nomargin">
						<div class="container clearfix">
							<div class="divcenter center" style="max-width: 900px;">
								<h2 class="nobottommargin t300 ls1">Chúng tôi thích làm việc trên các Dịch vụ và Sản phẩm mà chúng tôi cung cấp nhiều như bạn cần. Điều này giúp chúng tôi dễ dàng phân phối Mục tiêu của bạn. Duyệt qua nhiều dịch vụ mà chúng tôi cung cấp.</h2>
							</div>
						</div>
					</div>
				...
				<div id="section-blog" class="page-section">
					...
					<h2 class="center uppercase t300 ls3 font-body">Một vài hoạt động của công ty</h2>
